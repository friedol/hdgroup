...
// All storefront routes — gated by online-shop toggle
Route::middleware('online-shop')->group(function () {
    ...
    Route::post('/checkout/process', [CartController::class, 'store_checkout']);
...
Route::get('/email/verify/{id}/{hash}', function ($id, $hash, Request $request) {
    ...
    $user = User::find($id) ?: Customer::find($id);
...
// These remain outside the online-shop gate so authenticated customers can still access their orders
