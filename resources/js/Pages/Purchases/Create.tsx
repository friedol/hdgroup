...
export default function Create({ suppliers, products, warehouses }: any) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        post('/purchases', {
            ...
            onError: () => {
                Swal.fire({
                    title: 'Error!',
                    text: 'Failed to record purchase. Please check the form for errors.',
                    icon: 'error',
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="max-w-[1700px] mx-auto space-y-6 pb-20">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-[18px] font-bold text-slate-900 tracking-tight leading-none">New Purchase</h1>
