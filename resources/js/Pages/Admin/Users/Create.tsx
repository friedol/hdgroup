...
export default function UserCreate({ roles, branches }: PageProps) {
      ...
      <div className="space-y-6 pb-10">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500">Register a new staff member</p>
          </div>
        </div>
               ...
               <CardHeader className="text-center">
                  <div className="flex flex-col items-center space-y-4">
                     ...
                     <div className="text-center">
                        <p className="font-semibold text-slate-900">{data.staff_name || "New Staff Member"}</p>
                        <Badge variant="secondary" className="text-[10px] mt-1 uppercase font-bold">New Identity</Badge>
                     </div>
                  </div>
               </CardHeader>
                   ...
                   <div className="p-4 bg-slate-50 rounded-lg flex gap-4">
                      ...
                      <div className="space-y-1">
                         ...
                         <p className="text-[10px] text-slate-500 leading-relaxed font-medium">
                            Please ensure the password meets the minimum security requirements. Users can reset their password through the forgot password link if enabled.
                         </p>
                      </div>
                   </div>
                </CardContent>
