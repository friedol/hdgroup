...
export default function Create({ branches }: { branches: Branch[] }) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    formData.append("branch_id", data.branch_id === "0" ? "" : data.branch_id);
    ...
    post("/settings/popup-ads", formData as any);
  };
  ...
  return (
    <>
      <Head title="Create popup ad" />
      <AppLayout breadcrumbs={breadcrumbs}>
        <SettingsLayout activeTab={activeTab} onTabChange={setActiveTab} sidebarTitle="Settings">
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-2xl font-bold text-foreground">Create Popup Ad</h1>
                <p className="text-muted-foreground text-sm">Add a new popup advertisement to your storefront</p>
              </div>
              <Button
                type="button"
                variant="outline"
                ...
                <div className="w-full aspect-square rounded overflow-hidden shadow-sm flex items-center justify-center bg-slate-100 max-w-xs mx-auto">
                  {preview ? (
                    ...
                    <div className="text-center space-y-2">
                      ...
                      <p className="text-xs text-slate-400 font-medium">Select a square or portrait image</p>
                    </div>
                  )}
                </div>
            ...
            <CardContent className="space-y-6 px-6 pb-6">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    id="subtitle"
                    placeholder="Additional description or call-to-action"
                    value={data.subtitle}
