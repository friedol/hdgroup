...
export default function Edit({ heroSlide, branches }: { heroSlide: HeroSlide; branches: Branch[] }) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    put(`/settings/hero-slides/${heroSlide.id}`, formData);
  };
  ...
  return (
    <>
      <Head title={`Edit: ${heroSlide.title}`} />
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-muted-foreground text-sm">{heroSlide.title}</p>
              </div>
              <Button
                type="button"
                variant="outline"
