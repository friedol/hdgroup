        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-slate-600 mt-1">Create a new shipment manifest</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Basic details for the manifest</CardDescription>
              </CardHeader>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      className={errors.order_name ? "border-red-500" : ""}
                    />
                    {errors.order_name && <p className="text-red-500 text-xs mt-1">{errors.order_name}</p>}
                  </div>
                  <div>
                    <label className="block text-sm font-medium mb-2">Container *</label>
                    <select
                      className={`w-full px-3 py-2 border rounded-lg ${errors.container_id ? "border-red-500" : ""}`}
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0">
                <div>
                  ...
                  <CardDescription>Add products to the manifest</CardDescription>
                </div>
