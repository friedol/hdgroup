      ...
      <AppLayout breadcrumbs={breadcrumbs}>
        <div className="max-w-[1700px] mx-auto space-y-6 pb-20">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-[18px] font-bold text-slate-900 tracking-tight leading-none">Create Container</h1>
              <p className="text-xs font-medium text-slate-500 mt-1.5">Register a new shipping container</p>
            </div>
          </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      className={`${inputClass} ${errors.container_id ? "border-red-500 focus:border-red-500 focus:ring-red-100" : ""}`}
                    />
