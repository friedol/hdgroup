            ...
            <div className="min-h-screen bg-slate-50">
                ...
                <section className="bg-blue-600 py-12 text-white relative overflow-hidden">
                    ...
                    <div className="w-[98%] md:w-[88%] max-w-[1600px] mx-auto px-2 sm:px-4 md:px-8 relative z-10 text-center">
                        <span className="inline-block bg-white/20 text-white text-xl font-dancing font-bold px-5 py-1.5 rounded-full mb-4 backdrop-blur-sm border border-white/30">Product Categories</span>
                        <h1 className="text-2xl md:text-3xl font-extrabold mb-3 tracking-tight">Explore our Categories</h1>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 md:gap-6">
                        {categories.map((category, index) => {
                            const bgColors = [
                                ...
                                'bg-gradient-to-br from-red-50 to-red-100 hover:border-red-300 hover:shadow-red-100 ring-red-300',
