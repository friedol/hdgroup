...
import { Globe, Building2, Receipt, Shield, Database, ImageIcon, Plus } from "lucide-react";
...
const menuItems = [
  ...
  { id: "slides", label: "Carousels & Ads", icon: ImageIcon },
  { id: "hero-slides", label: "Hero Slides", icon: Plus },
  { id: "popup-ads", label: "Popup Ads", icon: Plus },
];
      ...
      <div className="w-full lg:w-64 shrink-0">
        ...
        <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-100">
          ...
          <p className="text-[10px] text-blue-700 leading-relaxed font-medium">
            Each item maintains independent configuration clusters managed per branch.
          </p>
        </div>
      </div>
